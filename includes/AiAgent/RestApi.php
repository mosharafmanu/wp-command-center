...
final class RestApi {
	...
	public function require_media_enhance( \WP_REST_Request $request ): bool|\WP_Error {
		...
		$write_actions = [ 'thumbnail_regenerate', 'thumbnail_regenerate_attachment', 'thumbnail_regenerate_batch', 'webp_generate', 'webp_generate_batch', 'image_optimize', 'image_optimize_batch' ];
