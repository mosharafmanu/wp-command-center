...
final class CommandCodeIntegration extends BaseClientIntegration {
	...
	public static function post_setup_notes(): array {
		return [
			__( 'When you add the server, Command Code may say “Server requires OAuth authentication”. It is reading this site’s refusal of an unauthenticated request as an OAuth challenge. There is no OAuth sign-in to complete — the access token in the header above is the whole of it, and the server is added and enabled regardless.', 'siteradian' ),
		];
	}
}
