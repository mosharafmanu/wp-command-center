...
final class CapabilityManager {
	...
	public function run( array $params, array $context = [] ): array|\WP_Error {
		...
		return match ( $action ) {
			...
			default => new \WP_Error( 'wpcc_invalid_capability_action', __( 'Unknown action.', 'siteradian' ) ),
		};
	}
	...
	private function get_caps( array $params ): array|\WP_Error {
		...
		if ( '' === $subject_id ) {
			return new \WP_Error( 'wpcc_missing_subject_id', __( 'subject_id is required.', 'siteradian' ) );
		}
		return [
	...
	private function assign( array $params, array $context ): array|\WP_Error {
		...
		if ( '' === $capability ) {
			return new \WP_Error( 'wpcc_missing_capability', __( 'capability is required.', 'siteradian' ) );
		}
	...
	private function validate_op( array $params, array $context ): array|\WP_Error {
		...
		if ( '' === $operation ) {
			return new \WP_Error( 'wpcc_missing_operation', __( 'operation is required.', 'siteradian' ) );
		}
