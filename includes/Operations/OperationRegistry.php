	...
	public function get_operations(): array {
		$operations = [
			...
			'media_enhance' => [
				...
				'requires_approval' => false,
				'parameters'        => [
					[ 'name' => 'action', 'type' => 'string', 'required' => true, 'enum' => [ 'media_enhance_capabilities', 'image_sizes_list', 'image_size_usage_audit', 'image_size_recommendations', 'image_size_verify', 'srcset_verify', 'responsive_image_audit', 'missing_sizes_audit', 'image_size_context_audit', 'thumbnail_verify', 'thumbnail_regenerate', 'thumbnail_regenerate_attachment', 'thumbnail_regenerate_batch', 'webp_audit', 'webp_verify', 'webp_generate', 'webp_generate_batch' ], 'description' => 'The diagnostic, regeneration, or WebP action to run.' ],
