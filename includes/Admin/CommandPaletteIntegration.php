 ...
 *     protection  → nothing
 *
 * Neither result mentions SiteRadian, and the first is actively wrong — the
 ...
 * a live install: "token" now answers "SiteRadian: Access tokens" first,
...
final class CommandPaletteIntegration {
	...
	public function enqueue(): void {
		...
		wp_localize_script( $handle, 'wpccCommandPalette', [
			...
			'i18n'         => [
				...
				'commandLabel' => __( 'SiteRadian: %s', 'siteradian' ),
				/*
				 ...
				 */
				'product'      => __( 'SiteRadian', 'siteradian' ),
			],
		] );
	}
	 ...
	 * so "SiteRadian: Settings › Connections › Access tokens" says "Settings"
