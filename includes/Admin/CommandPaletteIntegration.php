 ...
 *     protection  → nothing
 *
 * Neither result mentions SiteRadian AI, and the first is actively wrong — the
 ...
 * a live install: "token" now answers "SiteRadian AI: Access tokens" first,
...
final class CommandPaletteIntegration {
	...
	public function enqueue(): void {
		...
		wp_localize_script( $handle, 'wpccCommandPalette', [
			...
			'i18n'         => [
				...
				'commandLabel' => __( 'SiteRadian AI: %s', 'siteradian' ),
				/*
				 ...
				 */
				'product'      => __( 'SiteRadian AI', 'siteradian' ),
			],
		] );
	}
	 ...
	 * so "SiteRadian AI: Settings › Connections › Access tokens" says "Settings"
