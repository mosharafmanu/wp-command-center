...
$wpcc_diag_panes = [
	'health'          => [ 'label' => __( 'Health', 'siteradian' ),         'view' => 'diagnostics' ],
	'recommendations' => [ 'label' => __( 'Recommendations', 'siteradian' ), 'view' => 'recommendations' ],
	'sitereport'      => [ 'label' => __( 'Site Report', 'siteradian' ),     'view' => 'site-intelligence' ],
];
...
if ( DeveloperTools::enabled() ) {
	$wpcc_diag_panes['patches'] = [ 'label' => __( 'Patches', 'siteradian' ), 'view' => 'patches' ];
}
...
?>
<nav class="wpcc-cds-subnav" aria-label="<?php esc_attr_e( 'Diagnostics sections', 'siteradian' ); ?>">
