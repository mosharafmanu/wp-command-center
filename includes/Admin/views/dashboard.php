	...
	<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px;">
		...
		<div>
			...
			<div class="wpcc-panel">
				<div class="wpcc-panel-body">
					<p>
						...
						?>
						<a class="button button-small" href="<?php echo esc_url( admin_url( 'admin.php?page=wpcc-activity&wpcc_tab=approvals' ) ); ?>"><?php esc_html_e( 'Open Approval Center', 'wp-command-center' ); ?></a>
					</p>
				</div>
			</div>
			<?php endif; ?>
			...
			<div class="wpcc-panel" id="operation-results">
				...
				<?php foreach ( $wpcc_recent_results as $result ) : ?><tr><td><?php echo esc_html( $result['operation_id'] ); ?></td><td><span class="wpcc-status-badge wpcc-status-<?php echo esc_attr( $result['status'] ); ?>"><?php echo esc_html( $result['status'] ); ?></span></td><td><a href="<?php echo esc_url( add_query_arg( [ 'page' => 'wpcc-settings', 'wpcc_tab' => 'runtime', 'result_id' => $result['result_id'] ], admin_url( 'admin.php' ) ) . '#operation-results' ); ?>"><?php esc_html_e( 'View result', 'wp-command-center' ); ?></a></td></tr><?php endforeach; ?>
			...
			<div class="wpcc-panel">
				...
				<div class="wpcc-panel-body">
					<form method="get" class="wpcc-timeline-filters">
						<input type="hidden" name="page" value="wpcc-settings">
					...
					<?php endif; ?>
					<div class="wpcc-pagination"><span><?php echo esc_html( sprintf( __( 'Page %1$d of %2$d', 'wp-command-center' ), $wpcc_timeline_page, $wpcc_timeline_total_pages ) ); ?></span><span><?php if ( $wpcc_timeline_page > 1 ) : ?><a class="button" href="<?php echo esc_url( add_query_arg( [ 'page' => 'wpcc-settings', 'wpcc_tab' => 'runtime', 'timeline_type' => $wpcc_timeline_type, 'timeline_status' => $wpcc_timeline_status, 'timeline_page' => $wpcc_timeline_page - 1 ], admin_url( 'admin.php' ) ) ); ?>"><?php esc_html_e( 'Previous', 'wp-command-center' ); ?></a><?php endif; ?> <?php if ( $wpcc_timeline_page < $wpcc_timeline_total_pages ) : ?><a class="button" href="<?php echo esc_url( add_query_arg( [ 'page' => 'wpcc-settings', 'wpcc_tab' => 'runtime', 'timeline_type' => $wpcc_timeline_type, 'timeline_status' => $wpcc_timeline_status, 'timeline_page' => $wpcc_timeline_page + 1 ], admin_url( 'admin.php' ) ) ); ?>"><?php esc_html_e( 'Next', 'wp-command-center' ); ?></a><?php endif; ?></span></div>
				</div>
			</div>
		</div>
