...
final class AgentExplainer {
	...
	public static function faq(): array {
		return [
			[
				'q' => __( 'What is an AI agent?', 'ai-command-center' ),
				'a' => __( 'An AI assistant — like Claude — running in a separate app on your computer (for example the Claude desktop app). It is the thing that actually reads your site and suggests changes. WP Command Center does not include the AI itself; it safely connects one to your site.', 'ai-command-center' ),
			],
			[
				'q' => __( 'Why do I need one?', 'ai-command-center' ),
				'a' => __( 'WP Command Center is the safe doorway between an AI assistant and your WordPress site. Without an assistant connected, there is nothing to send work to. With one connected, it can do tasks like writing SEO titles or image alt text — and you stay in control of every change.', 'ai-command-center' ),
			],
			[
				'q' => __( 'What does the access token do?', 'ai-command-center' ),
				'a' => __( 'It is a password just for the AI assistant. You paste it into the assistant once, so it can talk to this site — and only do what the token allows. You can revoke it any time to instantly cut off access.', 'ai-command-center' ),
			],
			[
