/**
 * Register SiteRadian's screens with WordPress's own ⌘K command palette.
 *
...
( function () {
	...
	function register() {
		...
		var template = ( cfg.i18n && cfg.i18n.commandLabel ) || 'SiteRadian: %s';
		var product  = ( cfg.i18n && cfg.i18n.product ) || 'SiteRadian';
