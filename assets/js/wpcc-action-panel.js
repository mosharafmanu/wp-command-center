/**
 * SiteRadian AI — Governed Action Panel (generalized Quick Panel).
 *
...
( function () {
	...
	// ── Row dropdown chooser (compact menu off the ✨ SiteRadian AI row action) ─────────
	...
	function onClick( e ) {
		...
		// Consolidated "✨ SiteRadian AI" entry.
		if ( key === 'assist' ) {
