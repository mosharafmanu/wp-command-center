...
Development-phase reports organized by category.

| Directory | Contents | Count |
|-----------|----------|-------|
| [audits/](audits/) | Codebase, architecture, security, performance, and enterprise hardening audits | 14 |
| [validation/](validation/) | Step-level and final validation reports | 10 |
