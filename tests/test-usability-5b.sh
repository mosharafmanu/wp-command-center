...
echo "== 4. Provider catalogue — honest, future-proof (PROGRAM-6: expanded to types()) =="
...
has "runtime honesty: config-only status exists" "RUNTIME_CONFIG" "$CATALOG"
has "AI Setup iterates the catalogue" "ProviderCatalog::types\(\)" "$AISETUP"
